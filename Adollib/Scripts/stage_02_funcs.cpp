...
namespace Adollib
{
	Gameobject* Stage_02::set_tree(const Vector3& pos, const Vector3& scale, const Vector3& rotate, const float y_scale, const float tan_scale, Gameobject* pearent) {
	...
	Gameobject* Stage_02::set_pillar(const Vector3& pos, const Vector3& scale, const Vector3& rotate, Gameobject* pearent, const float base_length, const float pillar_length, bool moveable) {
	...
	Gameobject* Stage_02::set_fence(const Vector3& pos, const Vector3& scale, const Vector3& rotate, Gameobject* pearent, const int fence_count) {
	...
	Gameobject* Stage_02::set_door(const Vector3& pos, const Vector3& scale, const Vector3& rotate, const int is_left, Gameobject* pearent) {
		...
		// 外装
		{
			...
			auto coll = lever_box->addComponent<Collider>();
			{
...

				{
					...
					c->size = Vector3(1.5f, 1.5f, 0.1f) * scale_pow; //boxの当たり判定小さく
	...
	Gameobject* Stage_02::set_Andcircuit(Stage_parts::Stageparts_tagbit in_tag0, Stage_parts::Stageparts_tagbit in_tag1, Stage_parts::Stageparts_tagbit out_tag, Gameobject* pearent) {
	...
	Gameobject* Stage_02::set_player_statue(const Vector3& pos, const float& scale, const Vector3& rotate, Gameobject* pearent) {
	...
	Gameobject* Stage_02::set_sphere_rope(const Vector3& pos, const float& scale, const Vector3& rotate, int quantity, float mass, const Vector3& color) {
	...
	Gameobject* Stage_02::set_desk(const Vector3& pos, const Vector3& scale, const Vector3& rotate, float mass) {
	...
	Gameobject* Stage_02::set_gear(const Vector3& pos, const Vector3& size, const Vector3& rotate, float mass, int tooth_count) {
