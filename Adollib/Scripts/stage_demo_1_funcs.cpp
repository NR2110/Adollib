...
namespace Adollib
{
	...
	Gameobject* Stage_demo_01::set_desk(const Vector3& pos, const Vector3& scale, const Vector3& rotate, float mass) {
	...
	Gameobject* Stage_demo_01::set_gear(const Vector3& pos, const Vector3& size, const Vector3& rotate, float mass, int tooth_count) {
	...
	Gameobject* Stage_demo_01::set_buttan(const Vector3& pos, const Vector3& scale, const Vector3& rotate, Stage_parts::Stageparts_tagbit tag, const Vector3& color) {
	...
	Gameobject* Stage_demo_01::set_door(
	...
	Gameobject* Stage_demo_01::set_sphere_rope(const Vector3& pos, const float& scale, const Vector3& rotate, int quantity, float mass, const Vector3& color) {
