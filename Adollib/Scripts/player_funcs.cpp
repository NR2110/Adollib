...
void Player::shot_rope() {
	...
	if (input_changer->is_rope_state) {
		...
		camera_ray.position = camera->transform->position + camera_ray.direction * vector3_dot(Lhand->transform->position - camera->transform->position, camera_ray.direction);
