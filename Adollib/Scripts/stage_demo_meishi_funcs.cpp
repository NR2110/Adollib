...
namespace Adollib
{
	Gameobject* Stage_demo_meishi::set_tree(const Vector3& pos, const Vector3& scale, const Vector3& rotate, const float y_scale, const float tan_scale, Gameobject* pearent) {
	...
	Gameobject* Stage_demo_meishi::set_pillar(const Vector3& pos, const Vector3& scale, const Vector3& rotate, Gameobject* pearent, const float base_length, const float pillar_length, bool moveable) {
	...
	Gameobject* Stage_demo_meishi::set_fence(const Vector3& pos, const Vector3& scale, const Vector3& rotate, Gameobject* pearent, const int fence_count) {
	...
	Gameobject* Stage_demo_meishi::set_door(const Vector3& pos, const Vector3& scale, const Vector3& rotate, const int is_left, Gameobject* pearent) {
	...
	Gameobject* Stage_demo_meishi::set_buttan(const Vector3& pos, const Vector3& scale, const Vector3& rotate, Stage_parts::Stageparts_tagbit tag, Gameobject* pearent, bool is_use_trigger) {
	...
	Gameobject* Stage_demo_meishi::set_gimmickdoor(
	...
	Gameobject* Stage_demo_meishi::set_Andcircuit(Stage_parts::Stageparts_tagbit in_tag0, Stage_parts::Stageparts_tagbit in_tag1, Stage_parts::Stageparts_tagbit out_tag, Gameobject* pearent) {
	...
	Gameobject* Stage_demo_meishi::set_player_statue(const Vector3& pos, const float& scale, const Vector3& rotate, Gameobject* pearent) {
	...
	Gameobject* Stage_demo_meishi::set_sphere_rope(const Vector3& pos, const float& scale, const Vector3& rotate, int quantity, float mass, const Vector3& color) {
	...
	Gameobject* Stage_demo_meishi::set_desk(const Vector3& pos, const Vector3& scale, const Vector3& rotate, float mass) {
	...
	Gameobject* Stage_demo_meishi::set_gear(const Vector3& pos, const Vector3& size, const Vector3& rotate, float mass, int tooth_count) {
