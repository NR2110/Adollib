...
namespace Adollib {
	...
	struct Collider_tags {
		...
		static const Collider_tagbit Player00 = (1 << 21);
		static const Collider_tagbit Player01 = (1 << 22);
		static const Collider_tagbit Player02 = (1 << 23);
		static const Collider_tagbit Player03 = (1 << 24);
