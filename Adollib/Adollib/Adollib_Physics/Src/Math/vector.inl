...
//operator
		...
		inline Vector3 Adollib::Physics_function::operator*(float S, const Vector3& M) {
			Vector3 R;
			R.x = M.x * S;
			R.y = M.y * S;
			R.z = M.z * S;
		...
		inline float Adollib::Physics_function::vector3_distance_sqr(const Vector3& P, const Vector3& Q) {
			return
				sqrtf((P.x - Q.x) * (P.x - Q.x) + (P.y - Q.y) * (P.y - Q.y) + (P.z - Q.z) * (P.z - Q.z));
		}

		inline float Adollib::Physics_function::vector3_distance(const Vector3& P, const Vector3& Q) {
			return (P.x - Q.x) * (P.x - Q.x) + (P.y - Q.y) * (P.y - Q.y) + (P.z - Q.z) * (P.z - Q.z);
		}


		inline float Adollib::Physics_function::vector3_dot(const Vector3& P, const Vector3& Q) {
			return P.x * Q.x + P.y * Q.y + P.z * Q.z;
		}


		inline Vector3 Adollib::Physics_function::vector3_cross(const Vector3& P, const Vector3& Q) {
			Vector3 R;
			R.x = P.y * Q.z - P.z * Q.y;
			R.y = P.z * Q.x - P.x * Q.z;
			R.z = P.x * Q.y - P.y * Q.x;
		...
		inline float Adollib::Physics_function::vector3_angle(const Vector3& P, const Vector3& Q) {

			return ToAngle(vector3_radian(P, Q));
		}
		inline float Adollib::Physics_function::vector3_radian(const Vector3& P, const Vector3& Q) {

			float buf = ALClamp(Adollib::Physics_function::vector3_dot(P.unit_vect(), Q.unit_vect()), -1, 1);
			return acosf(buf);
		}

		inline Vector3 Adollib::Physics_function::vector3_look_at(const Vector3& P, const Vector3& Q) {
			return Q - P;
		}

		inline Vector3 Adollib::Physics_function::vector3_slerp(const Vector3& V1, const Vector3& V2, float R) {
...
//operator
		...
		inline Vector4 Adollib::Physics_function::operator*(float S, const Vector4& M) {
			Vector4 R;
			R.x = M.x * S;
			R.y = M.y * S;
			R.z = M.z * S;
...
//operator
		...
		inline Vector2 Adollib::Physics_function::operator*(float S, const Vector2& M) {
			Vector2 R;
			R.x = M.x * S;
			R.y = M.y * S;
			return R;
		...
		inline float Adollib::Physics_function::vector2_distance_sqr(const Vector2& P, const Vector2& Q) {
			return
				sqrtf((P.x - Q.x) * (P.x - Q.x) + (P.y - Q.y) * (P.y - Q.y));
		}

		inline float Adollib::Physics_function::vector2_distance(const Vector2& P, const Vector2& Q) {
			return (P.x - Q.x) * (P.x - Q.x) + (P.y - Q.y) * (P.y - Q.y);
		}


		inline float Adollib::Physics_function::vector2_dot(const Vector2& P, const Vector2& Q) {
			return P.x * Q.x + P.y * Q.y;
		}

		inline float Adollib::Physics_function::vector2_angle(const Vector2& P, const Vector2& Q) {

			return ToAngle(acosf(Adollib::Physics_function::vector2_dot(P.unit_vect(), Q.unit_vect())));
		}

		inline Vector2 Adollib::Physics_function::vector2_look_at(const Vector2& P, const Vector2& Q) {
			return Q - P;
		}
