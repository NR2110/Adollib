...
#pragma region operator
		...
		inline Matrix44 Matrix44::operator/ (float S) const {
			Matrix44 R;
			float invS = 1 / S;
			R._11 = _11 * invS; R._12 = _12 * invS;	R._13 = _13 * invS;	R._14 = _14 * invS;
			R._21 = _21 * invS; R._22 = _22 * invS;	R._23 = _23 * invS;	R._24 = _24 * invS;
			R._31 = _31 * invS; R._32 = _32 * invS;	R._33 = _33 * invS;	R._34 = _34 * invS;
			R._41 = _41 * invS; R._42 = _42 * invS;	R._43 = _43 * invS;	R._44 = _44 * invS;
			return R;
		}
...
#pragma endregion
		...
		inline Matrix44 Adollib::Physics_function::matrix44_identity() {
			Matrix44 M;
			M._11 = M._22 = M._33 = M._44 = 1;
			return M;
		}

		inline Matrix44 Adollib::Physics_function::matrix44_zero() {
			Matrix44 M;
			M *= 0;
			return M;
		}

		inline Matrix44 Adollib::Physics_function::matrix_trans(const Matrix44& M) {
			Matrix44 R = M;
		...
		inline float Adollib::Physics_function::matrix_determinant(const Matrix44& M) {
		...
		inline Matrix44 Adollib::Physics_function::matrix_inverse(const Matrix44& M) {
		...
		inline Vector3 Adollib::Physics_function::matrix_to_euler(const Matrix44& M) {
			Vector3 R;
			if (M._32 >= 1.0f) {
		...
		inline Vector3 Adollib::Physics_function::matrix_to_euler_radian(const Matrix44& M) {
			Vector3 R;
			if (M._32 >= 1.0f) {
				R.x = DirectX::XM_PIDIV2;
				R.y = 0;
		...
		inline Vector3 Adollib::Physics_function::vector3_trans(const Vector3& V, const Matrix44& M) {
			Vector3 R;
		...
		inline Matrix44 Adollib::Physics_function::matrix_world(const Vector3& scale, const Matrix44& rotate, const Vector3& trans) {
			Matrix44 ret = rotate;
		...
		inline DirectX::XMMATRIX Adollib::Physics_function::matrix_to_XMMATRIX(const Matrix44& M) {
		...
		inline Matrix44 Adollib::Physics_function::XMMATRIX_to_matrix44(const DirectX::XMMATRIX& X) {
		...
		inline Matrix44 Adollib::Physics_function::matrix44_cross(const Vector3& vec) {
			return Matrix44(
				0.0f, vec.z, -vec.y, 0,
				-vec.z, 0.0f, vec.x, 0,
				vec.y, -vec.x, 0.0f, 0,
		...
		inline Matrix44 Adollib::Physics_function::matrix44_scale(const Vector3& vec) {
			return Matrix44(
				vec.x, 0, 0, 0,
				0, vec.y, 0, 0,
				0, 0, vec.z, 0,
