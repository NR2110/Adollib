...
#pragma region constract
		...
		inline Quaternion::Quaternion(const DirectX::XMFLOAT3& Q)  noexcept :XMFLOAT4(Q.x, Q.y, Q.z, 0) {
		}
		inline Quaternion::Quaternion(const DirectX::XMFLOAT4& Q)  noexcept :XMFLOAT4(Q.x, Q.y, Q.z, Q.w) {
		}
...
#pragma region operator
		...
		inline Quaternion Adollib::Physics_function::operator*(float S, const Quaternion& Q) {
			Quaternion R = Q;
			R.w *= S;
			R.x *= S;
			R.y *= S;
...
#pragma endregion
		...
		inline Quaternion Adollib::Physics_function::quaternion_identity() {
			return Quaternion(1, 0, 0, 0);
		}

		inline Vector3 Adollib::Physics_function::vector3_quatrotate(const Vector3& V, const Quaternion& Q) {
#if 0
			vector3 R;
		...
		inline Quaternion Adollib::Physics_function::quaternion_axis_angle(const Vector3& axis, float S) {
			return quaternion_axis_radian(axis, ToRadian(S));
		}
		inline Quaternion Adollib::Physics_function::quaternion_axis_radian(const Vector3& axis, float S) {
		...
		inline Quaternion Adollib::Physics_function::quaternion_slerp(const Quaternion& Q1, const Quaternion& Q2, float R) {
		...
		inline Quaternion Adollib::Physics_function::quaternion_from_euler(float x, float y, float z) {
		...
		inline Quaternion Adollib::Physics_function::quaternion_from_euler(Vector3 V) {
		...
		//	return Rz * Rx * Ry;
		//}
		inline Quaternion Adollib::Physics_function::quaternion_by_rotate_matrix(Matrix44& M) {
		...
		inline Quaternion Adollib::Physics_function::quaternion_look_at(Vector3& me, Vector3& you) {
			Vector3 Q = you - me;
			return quaternion_from_to_rotate(Vector3(0, 0, 1), Q);
		}


		inline float Adollib::Physics_function::quaternion_dot(const Quaternion& Q1, const Quaternion& Q2) {
			return Q1.x * Q2.x + Q1.y * Q2.y + Q1.z * Q2.z + Q1.w * Q2.w;
		}

		inline Quaternion Adollib::Physics_function::quaternion_from_to_rotate(const Vector3& V1, const Vector3& V2) {
		...
		inline float Adollib::Physics_function::quaternion_angle(const Quaternion& Q1, const Quaternion& Q2) {
			return ToAngle(acosf(quaternion_dot(Q1.unit_vect(), Q2.unit_vect())));
		}
		inline float Adollib::Physics_function::quaternion_radian(const Quaternion& Q1, const Quaternion& Q2) {
